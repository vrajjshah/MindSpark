 ...
 -->                    
                ...
                <div class="card-body text-center wow fadeIn" data-wow-delay="0.2s" style="visibility: visible; animation-name: fadeIn; animation-delay: 0.2s;">
                    <!--Title-->
                         ...
                         <p class="card-text" > <h3> A war is coming!! Where’s the soul stone?
</h3>  </p>
    ...
    {
        if(strtolower($_POST['answer']) == 'hibb874yfhui7d yreil')
        {
               
                // echo "<script>alert('Correct Answer');</script>";
            
               $insert_stmt = $mysqli->prepare("UPDATE members SET levels='17', date=CURRENT_TIMESTAMP WHERE teamname = ?" );
