 ...
 -->                    
                ...
                <div class="card-body text-center wow fadeIn" data-wow-delay="0.2s" style="visibility: visible; animation-name: fadeIn; animation-delay: 0.2s;">
                    <!--Title-->
                         ...
                         <p class="card-text" > <h3>(0000)<sub>2</sub>= (0000)<sub>2</sub>, (0001)<sub>2</sub>= (0001)<sub>2</sub>, (1100)<sub>2</sub>= (1010)<sub>2</sub> then (1111)<sub>2</sub> = ? <br>(Hint - Gray is my favourite colour) </h3>  </p>
    ...
    {
        if(strtoupper($_POST['answer']) == '1000')
        {
