 ...
 -->                    
                ...
                <div class="card-body text-center wow fadeIn" data-wow-delay="0.2s" style="visibility: visible; animation-name: fadeIn; animation-delay: 0.2s;">
                    <!--Title-->
                         ...
                         <p class="card-text" > <h3>Convert given numbers into corresponding grey codes, And after multiply them, Which will be your answer.<br>{2,4,7,13}
</h3>  </p>
    ...
    {
        if(strtolower($_POST['answer']) == '792')
        {
