...
<section class="form-gradient d-flex" style="align-self: center;" >
    ...
    <div class="card ">
        ...
        <div class="card-body mx-5 mt-5">
            ...
            <div class="md-form pb-1 pb-md-3">
                <input type="password" class="form-control" name="confrimpwd" id="confrimpwd">
                <label for="Form-pass3">Confirm password</label>
                
            </div>
             <div class="md-form ">
                <input type="text" id="mobile" class="form-control"  name="mobile">
                <label for="Form-email3">Your mobile no.</label>
            </div>
            ...
            <button type="button" class="btn btn-grey btn-primary z-depth-1a "  onclick="return regformhash(this.form,
                                   this.form.teamname,
                                   this.form.email,
                                   this.form.password,
                                   this.form.confirmpwd,
                                   this.form.mobile);" >Sign up</button>
                    </div>
                </div>
                   </form>
                <!--Grid column-->
